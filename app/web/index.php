...
<body class="global-container h-100">
    ...
    <div id="home" class="w-100 h-100 bg-dark position-relative">
        <div class="profile-icon-container"> 
            <?php if ($clUser==null) { ?>
            <a href="signin.php">
                <img src="img_web/icone_user.png" alt="Icône de profil" class="profile-icon" style="width: 60px; height: auto;"/>
            </a>
            <?php } ?>
        </div>
        
        <video autoplay loop muted src="img_web/video.mp4" class="position-absolute w-100 h-100"></video>
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 justify-content-center pt-4 pb-5 mt-md-5 mt-0">
            ...
            <div class="d-flex flex-column align-items-center">
                <div class="row justify-content-center">
                    <img src="img_web/chat.svg" alt="chat icon" class="col-4">
                </div>
                <h2 class="fs-4">Lorem, ipsum dolor.</h2>
                <p color ="red" class="text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium error neque, sit quibusdam recusandae nam?</p>
            </div>
            
            <div class="d-flex flex-column align-items-center">
                <div class="row justify-content-center">
                    <img src="img_web/coding.svg" alt="coding icon" class="col-4">
                </div>
                <h2 class="fs-4">Lorem, ipsum dolor.</h2>
            ...
            <div class="d-flex flex-column align-items-center">
                <div class="row justify-content-center">
                    <img src="img_web/transfer.svg" alt="transfer icon" class="col-4">
                </div>
                <h2 class="fs-4">Lorem, ipsum dolor.</h2>
                <p class="text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium error neque, sit quibusdam recusandae nam?</p>
            </div>
    ...
    <section class="border-bottom">
        ...
        <div class="container mb-5 pb-5">
            ...
            <div class="row g-4 row-cols-1 row-cols-md-2 row-cols-lg-3">
                ...
                <div>
                    <div class="card">
                        <img src="img_web/robot.jpg" alt="robot image">
                        <div class="card-body">
                ...
                <div>
                    <div class="card">
                        <img src="img_web/purpleish-pic.jpg" alt="purple image">
                        <div class="card-body">
                            <h5 class="card-title">Project</h5>
                            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam, nisi?</p>
                            <a href="#" class="btn btn-primary">Take a look at it</a>
                ...
                <div>
                    <div class="card">
                        <img src="img_web/codebase.jpg" alt="codebase">
                        <div class="card-body">
                            <h5 class="card-title">Project</h5>
                            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam, nisi?</p>
                            <a href="#" class="btn btn-primary">Take a look at it</a>
                ...
                <div>
                    <div class="card">
                        <img src="img_web/laptop.jpg" alt="laptop">
                        <div class="card-body">
                            <h5 class="card-title">Project</h5>
                            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam, nisi?</p>
                            <a href="#" class="btn btn-primary">Take a look at it</a>
                ...
                <div>
                    <div class="card">
                        <img src="img_web/bright-laptop.jpg" alt="bright-laptop">
                        <div class="card-body">
                            <h5 class="card-title">Project</h5>
                            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam, nisi?</p>
                            <a href="#" class="btn btn-primary">Take a look at it</a>
                ...
                <div>
                    <div class="card">
                        <img src="img_web/desk-work.jpg" alt="desk work">
                        <div class="card-body">
                            <h5 class="card-title">Project</h5>
                            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam, nisi?</p>
                            <a href="#" class="btn btn-primary">Take a look at it</a>
...
<a href="traitement_formulaire.php">Contactez nous</a>
